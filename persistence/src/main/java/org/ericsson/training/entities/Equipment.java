...
@NamedQueries({
	 @NamedQuery(name = "Equipment.findByTac", query = "select o from Equipment o where o.tAC=:Tac"),
	 @NamedQuery(name = "Equipment.findByModel", query = "select o from Equipment o where o.model=:MODEL"),
})
